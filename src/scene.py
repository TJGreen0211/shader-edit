...
class Scene(GlfwRenderer):
    ...
    def _mouse_callback(self, window, xpos, ypos):
        ...
        # TODO: Handle higher for frame rates
        if state == glfw.PRESS:
    ...
    def _bind_object_vao(self, object_vertices):
    ...
    def _load_object(self, object_index, object_path=None):
        ...
        if object_path is not None:
            ...
            # TODO: Transfer this over to a obj file. This is a leftover from the initial prototype
        ...
        return self._bind_object_vao(object_vertices)

    def _get_delta_time(self, last_frame):
        current_frame = glfw.get_time()
        delta_time = current_frame - last_frame
        last_frame = current_frame
        return delta_time

    # This is overwritten from imgui implementation
    ...
    def draw_object(self, uniform_dict, textures_list, theta_time):
        ...
        :param uniform_dict: uniform key value pairs
        :type uniform_dict: dict

        :param textures_list: Textures to pass to the shaders
        :type textures_list: list

        :param theta_time: Time diff
        :type theta_time: list
        """
        try:
            ...
            glUniform3f(glGetUniformLocation(self.shader, b"camera_position"),
                *tuple(self.camera.get_camera_position(self.model)[0:3]))
