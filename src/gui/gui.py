...
class GUI(Scene):
    ...
    def __init__(self):
        ...
        # TODO: This probably needs to be in a config
    ...
    def save_fbo_as_image(self):
        ...
        """
        pixels = opengl.glReadPixels(
            0, 0, self.window_width, self.window_height, opengl.GL_RGBA, opengl.GL_UNSIGNED_BYTE)
    ...
    def menu(self):
        with imgui.font(self.font):
            ...
            imgui.plot_lines("", self.fps_values, scale_min=0.0,
                overlay_text="FPS: " + str(self.fps_values[-1]), graph_size=(300.0, 50.0))
